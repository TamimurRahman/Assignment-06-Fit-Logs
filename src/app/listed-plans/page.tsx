...
const Page = () => {
  ...
  const sortedExercises =
    tab === "today" ? sortedTodayPlan : sortedSavePlan;
            ...
            sortedExercises.map(
              (exercise: ExerciseType) => (
                ...
                >
                  ...
                  {/* View Details */}
                  <button
                    className="rounded-full border border-gray-700 px-4 py-2 text-[10px] text-gray-300 transition hover:border-gray-500 hover:text-white"
                  >
                    View Details
                  </button>
                  ...
                  {/* Mark Done */}
                  <button
                    className="rounded-full bg-lime-400 px-4 py-2 text-[10px] font-semibold text-black transition hover:bg-lime-300"
                  >
                    ✓ Mark as Done
                  </button>
