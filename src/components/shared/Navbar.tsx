...
const Navbar = () => {
  ...
  return (
   <nav className=" container mx-auto navbar sticky top-0 z-50 min-h-14 border-b border-gray-800 bg-[#0b0d0f] px-5 text-white">
      {/* ================= MOBILE MENU ================= */}
      <div className="navbar-start">
        ...
        <Link href="/" className="ml-1 flex items-center gap-2">
          <span className="text-lg text-lime-400"><Image src={logo} alt=""></Image></span>
